...
echo -e "  • 권장:         ${B}npm run ud -- 1.6.0-beta.7 \"chore(release): v1.6.0-beta.7\"${R}"
echo -e "  • 수동:         ${B}npm run build && npm run deploy${R}"
echo -e ""

echo -e "${B}${C4}[5] 버전 올리는 규칙${R}"
echo -e "  • 현재 단계: ${B}1.6.0-beta.7${R}"
...
echo -e "     - do-kkae-bi-onboarding-v1.6.0-beta.7"
echo -e "     - do-kkae-bi-onboarding-runtime-v1"
echo -e "  3) RTDB inventory/logs 경로 데이터 수신 여부"
echo -e ""
echo -e "${B}${C4}[10] 1.6.0-beta.7 핫픽스 점검 (가이드/기록페이지)${R}"
